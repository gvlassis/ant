...
parser.add_argument("--out_path", metavar="PATH", help="The directory which will contain train_X.pt, val_X.pt, test_X.pt. They are gonna be stored as torch.int16, because there is not torch.uint16", type=os.path.abspath, default=minipile_path)

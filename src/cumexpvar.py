...
print(f"\x1b[1m%2.2s %8.8s %12.12s %12.12s\x1b[0m" % ("ζ", "eigs", "arch", "cumexpvar0"))
for ζ in [1,2,4,8,16]:
    ...
    utils.write_cumexpvar(args.vocab_size, args.family, "mup", args.scale_type, ζ, args.context, "mup", device, args.dataset, batch_X, args.block)
    
    utils.write_cumexpvar(args.vocab_size, args.family, "mup", args.scale_type, ζ, args.context, "mupthresh", device, args.dataset, batch_X, args.block)
